...
describe("TrendInterest", function () {
    const deployTrendInterest = async () => {
        const [owner, otherAccount] = await ethers.getSigners();
        const TrendInterest = await ethers.getContractFactory("TrendInterest");
    ...
    describe("Function", () => {
        ...
        it("Should GetTrendInterest success", async () => {
            ...
            const interests = await trendInterest.getInterests();
        ...
        it("Should owner clear interests", async () => {
            ...
            await trendInterest.connect(owner).clearInterests();
        ...
        it("Should other account clear interests is revert", async () => {
            ...
            const tx = trendInterest.connect(otherAccount).clearInterests();
